...
//      [EspecificadorAcesso] tipo(int|string...) NOME_PROPRIEDADE;
//      
//      **Metodos
...
//se não usa nenhum modificador - automaticammente é public

public class Jogador{ //nomes de classes iniciar com a letra maiuscula -boa prática
...
class Aula28{
	...
	static void Main(){ //new reserva a memoria para o objeto - objetos de uma classe são idependentes um do outro. 

	//tres objetos da classe jogador
